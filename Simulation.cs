...
public class Simulation
{
    ...
    public Simulation(string versionName, double runSpeed)
	{
    ...
    public void RandomPopulate(int n)
    {
        for (int i = 0; i < n; i++)
        {
            ...
            Person newPerson = new Person(name, random.NextDouble(), random.NextDouble(), random.NextDouble(), random.NextDouble(), random.NextDouble(),random.NextDouble(),random.NextDouble());
            humanPopulation.Add(newPerson);
        }
    }
